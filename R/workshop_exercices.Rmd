...
Probemos a calcular la media, valor mínimo y máximo, el percentil 90 y el rango intercuartil para cada parcela. En este caso vemos que el valor resultante ya tiene menos filas, en concreto, una por parcela, y que sólo contiene las nuevas variables creadas.
...
podemos por ejemplo usar la función `do` para obtener las tres primeras líneas de cada parcela, usándola junto con la función `head`:
